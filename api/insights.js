...
export default async function(req,res){
  ...
  try{return res.json({ok:true,...await dailyInsights(date,{extended})})}catch(e){return res.status(502).json({ok:false,error:"Günlük analiz hazırlanamadı.",detail:String(e?.message||e)})}
}